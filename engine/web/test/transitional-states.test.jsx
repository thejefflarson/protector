// Visual-fidelity guard for the v4 transitional states (ADR-0025). The Preact
...
//  cutover (they carried classes with no CSS). These tests pin the class/token contract so
...
//
// (The one-shot cleared-row tombstone this file also guarded was removed in — a gone finding
...
describe("connection banner honesty register", () => {
