//! ELF static-linkage classification — re-exported from the shared `behavior`
//! crate.
//!
//! The classifier used to live here, but needs the SAME byte logic in the
...
//! `engine::observe::elf::elf_static_linkage` path (and the doc references) stay
//! stable.
//!
