...
/// The audit seam wires a durable sink into. A `redacted`-tier response never calls this
...
/// observability pipeline until attaches a durable store + the "Access" tab.
