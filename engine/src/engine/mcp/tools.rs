...
/// The image-observation subject prefix on the admission-decision log — mirrors the signing
/// sweep's own prefix, the rows the signing inventory is derived from.
