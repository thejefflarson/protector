...
/// Project one model-chosen cut into its row props: the node key ships UNTRUSTED (the
...
/// ) — a REPLACEMENT for the old single opaque cut-signature string. `None` (no incident
