...
//! posture is produced (the producer is the supply-chain sweep); it only shapes it for rendering. Two hard
...
//! read from the SAME `SigningRegression/<repo>` rows the sweep recorded (280) — the single
...
/// sweep recorded (280) — the recorded drift verdict a continuity gate enforces —
