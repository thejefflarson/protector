...
pub(crate) fn render_downstream(
    ...
    // A THIRD independent incident-wide pool for behavior-line free text (a security-review
    // follow-up): `Behavior::summary` embeds attacker-influenced free-text (an
