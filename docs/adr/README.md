...
| [0008](0008-model-adjudicates-never-authorizes.md) | The model adjudicates (one-way veto); it never authorizes, and never exploits | Accepted (amended by 0011, 0013) |
| [0009](0009-asymmetric-action-bar.md) | Asymmetric action bar: live evidence acts, latent exposure proposes | Accepted (amended by 0011, 0013) |
