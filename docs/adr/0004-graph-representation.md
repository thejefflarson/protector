...
tag, later removed — see that ADR's amendment) as the stable contract adapters map
...
- Strongly-typed node and edge enums implementing the ADR-0003 vocabulary. Every
  ...
  hypothesis-grade; removed the tag once nothing constructed a hypothesis-grade
