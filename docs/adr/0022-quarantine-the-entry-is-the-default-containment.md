...
edge-cut or the entry quarantine) — so this ADR's existing default-containment behavior and
the "prefer the narrower surgical cut" invariant are preserved byte-for-byte.
